...
namespace GotChamp.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        private PlayerUserManager _userManager;
        ...
        public AccountController(PlayerUserManager userManager,
        ...
        public PlayerUserManager UserManager
        {
            get
            {
                return _userManager ?? Request.GetOwinContext().GetUserManager<PlayerUserManager>();
            }
            private set
            {
                _userManager = value;
        ...
        public IHttpActionResult ChangePassword(ChangePasswordDto model)
        {
            ...
            try
            {
                ...
                bool isTrue = repo.ChangePassword(model.Email, model.Password);

                if (!isTrue)
                {
                    return BadRequest("Error in changing Password. :D");
                }
        ...
        public async Task<IHttpActionResult> GetExternalLogin(string provider, string error = null)
        {
            ...
            if (hasRegistered)
            {
                ...
                AuthenticationProperties properties = ApplicationOAuthProvider.CreateProperties(user.UserName,user.IsPlayed);
        ...
        private IHttpActionResult GetErrorResult(IdentityResult result)
        {
            ...
            if (!result.Succeeded)
            {
                if (result.Errors != null)
                {
                    ...
                    {
                        ModelState.AddModelError("stateError", error);
                    }
                }
        ...
        [HttpGet]
        [Route("Status")]
        public IHttpActionResult GetUserStatus(string userName)
        {
            try
            {
                var account = UserManager.FindByName(userName);
                 return Ok(account.IsPlayed);
            }
            catch (Exception)
            {
                return InternalServerError();
